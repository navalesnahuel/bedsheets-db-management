        ...
        for category_id, category_name in categories:
            for material_id, material_name in materials:
                for size_id, size_name in sizes:
                    ...
                    insert_values.append((product_name, cost_price, random.randint(3, 9), category_id, material_id, size_id))
                    
        cursor.executemany("""
            INSERT INTO Products (name, cost_price, stock_no, category_id, material_id, size_id) 
            VALUES (%s, %s, %s, %s, %s, %s);
        """, insert_values)
        conn.commit()
